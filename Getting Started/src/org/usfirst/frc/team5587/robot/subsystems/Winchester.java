 ...
 *
 */
public class Winchester extends PIDSubsystem {
	...
	private final double DISTANCE_PER_PULSE = 4;
	
	public Winchester() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        super("PIDWinch", 0.1, 0.0, 0.0);
        winchEnc.setDistancePerPulse( DISTANCE_PER_PULSE );
    ...
    protected double returnPIDInput() {
        ...
        // yourPot.getAverageVoltage() / kYourMaxVoltage;             Hello
    ...
    protected void usePIDOutput(double output) {
    	...
    	// This comment is fun to type lol so good 
    ...
    // What are you doing with your life? (I like this font)
	@Override

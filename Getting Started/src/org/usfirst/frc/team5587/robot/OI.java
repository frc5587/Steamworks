...
public class OI
{
    ...
    public Button screw, climb, unwind, invert, backOff, teleOp, intake, toss, hunger, digest, regret, deliver, succ;
    ...
    public OI() {
        ...
        hunger.whenPressed( new Hunger() );//new Hunger());
        digest.whenPressed( new Digest() );//new Digest());

...
import org.usfirst.frc.team5587.robot.commands.groundbox.GroundDown;
import org.usfirst.frc.team5587.robot.commands.groundbox.GroundUp;
...
public class OI
{
    ...
    public Button screw, climb, unwind, invert, backOff, teleOp, intake, toss;
    ...
    public OI() {
        ...
        SmartDashboard.putData("Roll In", new RollIn());
        SmartDashboard.putData("Roll Out", new RollOut());
        SmartDashboard.putData("Grind Down", new GroundDown());
        SmartDashboard.putData("Grind Up", new GroundUp());

...
import org.usfirst.frc.team5587.robot.commands.groundbox.GroundboxDelivery;
...
import org.usfirst.frc.team5587.robot.commands.groundbox.DumbItDown;
import org.usfirst.frc.team5587.robot.commands.groundbox.DumbItUp;
...
public class OI
{
    ...
    public Button screw, climb, unwind, invert, backOff, teleOp, intake, toss, hunger, digest, regret, deliver, succ, dumbDown, dumbUp, resetArm;
    ...
    public OI() {
        ...
        hunger = new JoystickButton( codriver, RobotMap.HUNGER_BUTTON );
        digest = new JoystickButton( codriver, RobotMap.DIGEST_BUTTON );
        regret = new JoystickButton( codriver, RobotMap.REGRET_BUTTON );
        deliver = new JoystickButton( codriver, RobotMap.DELIVER_BUTTON );
        dumbDown = new JoystickButton( codriver, RobotMap.DUMB_DOWN_BUTTON );
        resetArm = new JoystickButton( codriver, RobotMap.RESET_BUTTON );
        dumbUp = new JoystickButton( codriver, RobotMap.DUMB_UP_BUTTON );
        ...
        deliver.whenPressed( new GroundboxDelivery() );
        dumbDown.whileHeld( new DumbItDown() );
        dumbUp.whileHeld( new DumbItUp() );
        resetArm.whenPressed( new ResetEncArm() );
        ...
        SmartDashboard.putData( "Regret", new Regret());
        SmartDashboard.putData( "Deliver", new GroundboxDelivery() );
        ...
        SmartDashboard.putData("Fold", new FoldIn() );
        SmartDashboard.putData( "Drop Balls", new DropBalls() );

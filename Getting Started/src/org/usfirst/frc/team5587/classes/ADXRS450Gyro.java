...
public class ADXRS450Gyro {
	...
	static final byte ADXRS450_REG_RATE     =  (byte) 0x00;
	static final byte ADXRS450_REG_TEM      =  (byte) 0x02;
	static final byte ADXRS450_REG_LOCST    =  (byte) 0x04;
	static final byte ADXRS450_REG_HICST    =  (byte) 0x06;
	static final byte ADXRS450_REG_QUAD     =  (byte) 0x08;
	static final byte ADXRS450_REG_FAULT    =  (byte) 0x0A;
	static final byte ADXRS450_REG_PID      =  (byte) 0x0C;
	static final byte ADXRS450_REG_SN_HIGH  =  (byte) 0x0E;
	static final byte ADXRS450_REG_SN_LOW   =  (byte) 0x10;
	...
	private int GetID() {
		short id = getRegisterValue(ADXRS450_REG_PID);
		return id >> 8;
	}
	...
	private double GetTemperature() {
		...
		registerValue = getRegisterValue(ADXRS450_REG_TEM);
	...
	private class GyroUpdateTask extends TimerTask {
		...
		private GyroUpdateTask(ADXRS450Gyro gyro) {
			if (gyro == null) {
